...
(* OASIS_START *)
(* DO NOT EDIT (digest: c5f5360f28ec7ea4d8cabcaaf33fc490) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("rocks_tests",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$rocks_tests", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("ocaml-rocksdb", None);
                   ...
                   {exec_custom = true; exec_main_is = "test3.ml"});
               Test
                 ({
                     cs_name = "test3";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_command = [(OASISExpr.EBool true, ("$test3", []))];
                      test_custom =
                        {
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "rocks_tests.ml"});
               Test
                 ({
                     cs_name = "rocks_tests";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\204\217\002\179Q\157ji<\150?\029\155\156<d";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
